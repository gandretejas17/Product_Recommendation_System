...
prod_ranking_model = pd.read_pickle(open(os.path.join(directory,'prod_ranking_model.pkl'),'rb'))
cust_prod_ranking_model = pd.read_pickle(open(os.path.join(directory,'cust_prod_ranking_model.pkl'),'rb'))
cust_correlation_model = pd.read_pickle(open(os.path.join(directory,'cust_correlation_model.pkl'),'rb'))
prod_correlation_model = pd.read_pickle(open(os.path.join(directory,'prod_correlation_model.pkl'),'rb'))
